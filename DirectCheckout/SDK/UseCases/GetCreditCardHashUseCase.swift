...
protocol IGetCreditCardHashUseCase {
    func get(publicToken: String, encryptedData: String, completion: @escaping (_ result: Result<String, Error>) -> Void)
}
...
struct GetCreditCardHashUseCase: IGetCreditCardHashUseCase {
    ...
    func get(publicToken: String, encryptedData: String, completion: @escaping (Result<String, Error>) -> Void) {
